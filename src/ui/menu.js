...
function initMenu(revision, obsIsAnyOverlayShowing) {
    ...
    const stockPriceAnchor = /** @type {!HTMLAnchorElement} */ document.getElementById('example-stock-price-prediction');
    ...
    for (let [a, t] of [[stockPriceAnchor, stockPriceLink],
                        // [groverAnchor, groverLink],
                        // [shorAnchor, shorLink],
